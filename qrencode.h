...
#if defined(_MSC_VER)
    #if defined(MAKE_QRENCODE_LIB)
        #define QRENCODE_EXPORT __declspec(dllexport)
    #else
        #define QRENCODE_EXPORT __declspec(dllimport)
    #endif
#else
    #define QRENCODE_EXPORT
#endif
 ...
 */
QRENCODE_EXPORT extern QRinput *QRinput_new(void);
 ...
 */
QRENCODE_EXPORT extern QRinput *QRinput_new2(int version, QRecLevel level);
 ...
 * @throw EINVAL invalid arguments.
 */
QRENCODE_EXPORT extern QRinput *QRinput_newMQR(int version, QRecLevel level);
 ...
 *
 */
QRENCODE_EXPORT extern int QRinput_append(QRinput *input, QRencodeMode mode, int size, const unsigned char *data);
 ...
 *
 */
QRENCODE_EXPORT extern int QRinput_appendECIheader(QRinput *input, unsigned int ecinum);
 ...
 */
QRENCODE_EXPORT extern int QRinput_getVersion(QRinput *input);
 ...
 */
QRENCODE_EXPORT extern int QRinput_setVersion(QRinput *input, int version);
 ...
 */
QRENCODE_EXPORT extern QRecLevel QRinput_getErrorCorrectionLevel(QRinput *input);
 ...
 * @retval -1 invalid argument.
 */
QRENCODE_EXPORT extern int QRinput_setErrorCorrectionLevel(QRinput *input, QRecLevel level);
 ...
 * @retval -1 invalid argument.
 */
QRENCODE_EXPORT extern int QRinput_setVersionAndErrorCorrectionLevel(QRinput *input, int version, QRecLevel level);
 ...
 * @param input input object.
 */
QRENCODE_EXPORT extern void QRinput_free(QRinput *input);
 ...
 */
QRENCODE_EXPORT extern int QRinput_check(QRencodeMode mode, int size, const unsigned char *data);
 ...
 * @throw ENOMEM unable to allocate memory.
 */
QRENCODE_EXPORT extern QRinput_Struct *QRinput_Struct_new(void);
 ...
 */
QRENCODE_EXPORT extern void QRinput_Struct_setParity(QRinput_Struct *s, unsigned char parity);
 ...
 * @throw EINVAL invalid arguments.
 */
QRENCODE_EXPORT extern int QRinput_Struct_appendInput(QRinput_Struct *s, QRinput *input);

/**
 * Free all of QRinput in the set.
 * @param s a structured input object.
 */
QRENCODE_EXPORT extern void QRinput_Struct_free(QRinput_Struct *s);
 ...
 * @throw ENOMEM unable to allocate memory.
 */
QRENCODE_EXPORT extern QRinput_Struct *QRinput_splitQRinputToStruct(QRinput *input);
 ...
 * @throw ENOMEM unable to allocate memory.
 */
QRENCODE_EXPORT extern int QRinput_Struct_insertStructuredAppendHeaders(QRinput_Struct *s);

/**
 * Set FNC1-1st position flag.
 */
QRENCODE_EXPORT extern int QRinput_setFNC1First(QRinput *input);

/**
 * Set FNC1-2nd position flag and application identifier.
 */
QRENCODE_EXPORT extern int QRinput_setFNC1Second(QRinput *input, unsigned char appid);
 ...
 * @throw ENOMEM unable to allocate memory for input objects.
 */
QRENCODE_EXPORT extern QRcode *QRcode_encodeInput(QRinput *input);
 ...
 * @throw ERANGE input data is too large.
 */
QRENCODE_EXPORT extern QRcode *QRcode_encodeString(const char *string, int version, QRecLevel level, QRencodeMode hint, int casesensitive);

/**
 * Same to QRcode_encodeString(), but encode whole data in 8-bit mode.
 * @warning This function is THREAD UNSAFE when pthread is disabled.
 */
QRENCODE_EXPORT extern QRcode *QRcode_encodeString8bit(const char *string, int version, QRecLevel level);

/**
 * Micro QR Code version of QRcode_encodeString().
 * @warning This function is THREAD UNSAFE when pthread is disabled.
 */
QRENCODE_EXPORT extern QRcode *QRcode_encodeStringMQR(const char *string, int version, QRecLevel level, QRencodeMode hint, int casesensitive);

/**
 * Micro QR Code version of QRcode_encodeString8bit().
 * @warning This function is THREAD UNSAFE when pthread is disabled.
 */
QRENCODE_EXPORT extern QRcode *QRcode_encodeString8bitMQR(const char *string, int version, QRecLevel level);
 ...
 * @throw ERANGE input data is too large.
 */
QRENCODE_EXPORT extern QRcode *QRcode_encodeData(int size, const unsigned char *data, int version, QRecLevel level);

/**
 * Micro QR Code version of QRcode_encodeData().
 * @warning This function is THREAD UNSAFE when pthread is disabled.
 */
QRENCODE_EXPORT extern QRcode *QRcode_encodeDataMQR(int size, const unsigned char *data, int version, QRecLevel level);

/**
 * Free the instance of QRcode class.
 * @param qrcode an instance of QRcode class.
 */
QRENCODE_EXPORT extern void QRcode_free(QRcode *qrcode);
 ...
 */
QRENCODE_EXPORT extern QRcode_List *QRcode_encodeInputStructured(QRinput_Struct *s);
 ...
 * @throw ENOMEM unable to allocate memory for input objects.
 */
QRENCODE_EXPORT extern QRcode_List *QRcode_encodeStringStructured(const char *string, int version, QRecLevel level, QRencodeMode hint, int casesensitive);

/**
 * Same to QRcode_encodeStringStructured(), but encode whole data in 8-bit mode.
 * @warning This function is THREAD UNSAFE when pthread is disabled.
 */
QRENCODE_EXPORT extern QRcode_List *QRcode_encodeString8bitStructured(const char *string, int version, QRecLevel level);
 ...
 * @throw ENOMEM unable to allocate memory for input objects.
 */
QRENCODE_EXPORT extern QRcode_List *QRcode_encodeDataStructured(int size, const unsigned char *data, int version, QRecLevel level);
 ...
 */
QRENCODE_EXPORT extern int QRcode_List_size(QRcode_List *qrlist);

/**
 * Free the QRcode_List.
 * @param qrlist a head entry of a QRcode_List.
 */
QRENCODE_EXPORT extern void QRcode_List_free(QRcode_List *qrlist);
 ...
 */
QRENCODE_EXPORT extern void QRcode_APIVersion(int *major_version, int *minor_version, int *micro_version);
 ...
 */
QRENCODE_EXPORT extern char *QRcode_APIVersionString(void);
